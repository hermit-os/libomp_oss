...
CFLAGS_ADD =  -Isrc -Isrc/thirdparty/safeclib -Isrc/thirdparty/ittnotify -D INTEL_NO_ITTNOTIFY_API -D USE_ITT_NOTIFY=0 -D USE_ITT_BUILD=1 -D NDEBUG -D KMP_ARCH_STR="\"Intel(R) 64\"" -pthread -D KMP_USE_HWLOC=0 -D KMP_USE_ASSERT -D BUILD_I8 -D BUILD_TV=0 -D KMP_LIBRARY_FILE=\"libiomp5.so\" -D KMP_VERSION_MAJOR=5 -D KMP_CACHE_MANAGE=1 -D CACHE_LINE=64 -D KMP_ADJUST_BLOCKTIME=0 -D BUILD_PARALLEL_ORDERED -D KMP_ASM_INTRINS -D KMP_USE_INTERNODE_ALIGNMENT=0 -D KMP_USE_VERSION_SYMBOLS -D USE_CBLKDATA -D KMP_GOMP_COMPAT -D KMP_NESTED_HOT_TEAMS -D KMP_USE_ADAPTIVE_LOCKS=0 -D KMP_DEBUG_ADAPTIVE_LOCKS=0 -D KMP_STATS_ENABLED=0 -D OMP_50_ENABLED=0 -D OMP_41_ENABLED=0 -D OMP_40_ENABLED=1 -D KMP_TDATA_GTID  -D _KMP_BUILD_TIME="\"$(date)\""
